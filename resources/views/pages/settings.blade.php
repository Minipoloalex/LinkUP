        ...
        <div class="flex flex-col break-words bg-white border-2 rounded shadow-md">
            ...
            <form class="w-full p-6" method="POST" action="{{ route('settings.update') }}">
                ...
                <div class="flex flex-wrap mb-6">
                    ...
                    <input id="new_password" type="password" class="form-input w-full focus:outline-none" name="new_password" autocomplete="new-password">
                ...
                <div class="flex flex-wrap mb-6">
                    ...
                    <input id="new_password_confirmation" type="password" class="form-input w-full focus:outline-none" name="new_password_confirmation" autocomplete="new-password">
                </div>
                ...
                <div class="flex flex-wrap mb-6">
                    ...
                    <input id="current_password" type="password" class="form-input w-full focus:outline-none" name="current_password" required autocomplete="current-password">
            ...
            <form class="w-full p-6" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap mb-6"> 
                    ...
                    <input id="course" type="text" class="form-input w-full focus:outline-none" name="course" value="{{ $user->course }}" required autocomplete="course">
