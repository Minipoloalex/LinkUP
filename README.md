...
```
cd existing_repo
git remote add origin https://git.fe.up.pt/lbaw/lbaw2324/lbaw2351.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fe.up.pt/lbaw/lbaw2324/lbaw2351/-/settings/integrations)
